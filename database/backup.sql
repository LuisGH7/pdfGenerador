...
MySQL - 10.4.24-MariaDB : Database - experimentos
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`experimentos` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `comentarios`(`idcomentario`,`comentario`,`fechacomentario`) values 
(1,'<h1>hola</h1>','2022-10-14 09:43:34'),
(2,'<h2>SENATI</h2>','2022-10-14 09:43:36'),
(3,'holas','2022-10-14 10:05:06'),
(4,'','2022-10-14 10:06:49'),
(5,'<p><em><span style=\"color: rgb(22, 145, 121);\">Texto de prueba</span></em></p>','2022-10-14 10:09:06');
...
/* Procedure structure for procedure `spu_comentario_listar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_comentario_listar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_comentario_listar`()
begin
...
/* Procedure structure for procedure `spu_comentario_registrar` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_comentario_registrar` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_comentario_registrar`(
in _comentario text
)
begin
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_ubigeos_buscar`(
